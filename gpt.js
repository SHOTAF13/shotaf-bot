...
export const updateTaskSchema = {
  ...
  parameters: {
    ...
    required: [], // או תשאיר ריק, כדי שכולם יהיו אופציונליים
  }
}
  */
  ...
  parameters: {
    ...
    properties: {
      ...
      reminder_time: {
        type: 'string',
        pattern: '^\\d{2}:\\d{2}$',
        description: 'שעת תזכורת חדשה (HH:mm)'
      },
      category: {
        type: 'string',
      ...
      frequency: {
        type: 'string',
        description: 'תדירות חדשה כמו "יומי", "שבועי" וכו׳'
      },
      person_name: {
        type: 'string',
        description: 'שם האדם המשויך למשימה, אם שונה'
      },
      person_role: {
        type: 'string',
        description: 'תפקיד/קשר של האדם אם השתנה'
      }
    },
    required: []  // לא חייב משהו – יחזיר רק את מה שהשתנה
  }
};
